...
function createRoot(obj) {
  ...
  rootNode.setAttribute('style', 'padding: 5%; background-color: #D3D3D3; border-style: solid; display: flex; flex-direction: column;')
...
function createNode(obj) {
    ...
    newNode.setAttribute('style', 'padding: 5%; background-color: #D3D3D3; border-style: solid; display: flex; flex-direction: column;')
